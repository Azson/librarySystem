...
<head>
    ...
    <script type="text/javascript" src="validate/book_insert.js"></script>
</head>
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
				...
				<%-- 编写数据增加表单 --%>
					<form action="pages/back/book/BookServlet/insert" method="post" class="form-horizontal" id="insertForm" >
						<%-- 图书名称 --%>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control" id="aid" name="aid">
									...
									<option value="${admin.aid }"><c:out value="${admin.aid }" /></option>
									</c:forEach>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<select class="form-control" id="iid" name="iid">
									...
									<option value="${item.iid }"><c:out value="${item.name }" /></option>
									</c:forEach>
								</select>
							</div>
						</div>
